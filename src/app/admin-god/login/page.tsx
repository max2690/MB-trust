...
export default function AdminGodLoginPage() {
  ...
  const handleLogin = async (e: React.FormEvent) => {
    ...
    if (process.env.NODE_ENV === 'development') {
      ...
      setTimeout(() => {
        router.push('/admin-god/dashboard');
      }, 500);
      return;
    }
  ...
  return (
    <div className="min-h-screen bg-mb-black flex items-center justify-center p-4">
      <Card className="w-full max-w-md p-6">
        <div className="text-center mb-6">
          <h1 className="text-3xl font-bold text-white mb-2">🔴 Админ-Бог</h1>
          <p className="text-mb-gray">Вход в супер-админ панель</p>
        </div>
        ...
        <form onSubmit={handleLogin} className="space-y-4">
          ...
          <Button
            ...
            className="w-full bg-mb-red hover:bg-mb-red/90"
          >
            {loading ? 'Вход...' : 'Войти'}
          </Button>
        </form>
